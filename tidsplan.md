...
| 15:50 | Mingling utenfor + pizzasnurrer + velkomstdrink + foto | – | 85 min | Lett mat utendørs hvis vær |
| 17:15 | Dørene til middagssal åpnes – plassering | Toastmaster | 15 min | Gjester finner plassen (17:15–17:30) |
...
| 17:45 | **Tale 2 – Anders til Michelle** (FØR mat) | | 5 min | Setter tonen tidlig |
...
| Bolk | Tid |
|------|-----|
| Kirke + buss + mingling utendørs (pizzasnurrer) | 14:00 → 17:15 |
...
- **22 min pause** etter søsken-talene (inkl. Fireball 2) – kan strekkes.
...
- [x] Brudens søster(-e) – **Cathrine og Anette holder felles tale (Tale 7, etter forlovere).**
- [x] Anders' søster – **Ingrid holder felles tale med Ola (Tale 8, etter søstrene).**
- [x] **Michelle (bruden) holder tale TIDLIG** (Tale 3, FØR mat, rett etter Anders) – paret-utveksling.
- [x] **3 taler FØR forrett-servering**: Werner (far), Anders→Michelle, Michelle→Anders.
- [x] **Søstre + søsken flyttet bak forlovere** (etter ønske): Erik Nilsen (Tale 4) → forlovere (Tale 5–6) → søstre (Tale 7) → Anders' søsken (Tale 8).
- [x] **Kongsvinger-vennene** (Michelles barndomsvenner) holder gruppe-tale (Tale 9).
- [x] **«Feminin og fornem»** – Ås-gjengen / Michelles studievenninner fra NMBU – holder tale (Tale 10).
